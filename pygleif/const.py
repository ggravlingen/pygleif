URL_API = 'https://leilookup.gleif.org/api/v2/leirecords?lei='
...
URL_DIRECT_CHILD = 'https://api.gleif.org/api/v1/lei-records/{}/direct-child-' \
                   'relationships'
...
ATTR_ENTITY_REGISTRATION_AUTHORITY = 'RegistrationAuthority'
ATTR_ENTITY_REGISTRATION_AUTHORITY_ENTITY_ID = 'RegistrationAuthorityEntityID'
...
ATTR_ADDRESS_LINE1 = 'FirstAddressLine'
